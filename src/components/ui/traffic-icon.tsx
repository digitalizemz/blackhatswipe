...
export function TrafficIcon({ name, size = 16, className = '' }: TrafficIconProps) {
  const icons: Record<string, JSX.Element> = {
    ...
    'Native Ads': (
      <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="#FF6B35" strokeWidth="2" strokeLinecap="round" className={className}>
